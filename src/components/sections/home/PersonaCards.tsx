...
const personas = [
  {
    ...
    teaser:
      "Incoming EY co-op · $300K margin recovery at ShipNoble",
    cta: "Meet the Consultant",
    href: "/professional",
    highlights: ["FMVA · CAPM · BIDA · FITP", "ShipNoble Index", "Summer 2027 Co-op"],
  ...
  },
  {
    ...
    name: "Coach Ro",
    teaser:
      "Currently in his 11th season. 94-14-1 combined record. Six championships. Two three-peats. Four programmes.",
    cta: "Meet the Coach",
    href: "/coach",
    highlights: ["94-14-1 Record", "6 Championships", "Two Three-Peats"],
